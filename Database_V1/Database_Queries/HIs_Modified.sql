...
Create Table Core_system.UserRoles(
    RoleID int Not Null, 
    UserId int Not Null ,
...
Create Table Core_system.Departments(
    ...
    Constraint FK_Manager_ID FOREIGN KEY (ManagerID) References Core_system.Staff(StaffID)
)
...
CREATE TABLE Scheduling.PhysicianSchedules (
    ...
    CONSTRAINT FK_PhysicianSchedules_Staff FOREIGN KEY (PhysicianID) REFERENCES Staff(StaffID) 
);
...
CREATE TABLE Patient_Management.Patient (
    ...
    CreatedAt DATETIME2 DEFAULT GETDATE(),
    CreatedBy INT,
    CONSTRAINT FK_Patient_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Users(UserID)
);+
/*
    Emergency Module
*/
CREATE TABLE Emergency_Management.ER_Visit (
    ...
    Constraint FK_ER_Visit_EncouterID Foreign Key (EncounterID) References Encounters(EncounterId)
);
...
CREATE TABLE Emergency_Management.TriageAssessment (
    ...
    CONSTRAINT FK_TriageAssessment_AssessedBy FOREIGN KEY (AssessedBy) REFERENCES Staff(StaffID),
    CONSTRAINT FK_TriageAssessment_ERVisit FOREIGN KEY (ERVisitID) REFERENCES ER_Visit(ERVisitID)
...
CREATE TABLE Scheduling.Appointments (
    ...
    CreatedAt DATETIME2 DEFAULT GETDATE(),
    CreatedBy INT,
    Constraint FK_Patient_ID_Appointments Foreign Key (PatientID) References Patient(PatientID),
    Constraint FK_Staff_ID_Appointments Foreign Key (PhysicianID) References Staff(StaffID),
    Constraint  FK_Appointments_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Users(UserId),
);
/*
    Out patient Visit
*/
CREATE TABLE Outpatient_Mangement.OPD_Visit (
    ...
    Constraint FK_EncouterID_OPD_visit Foreign key (EncounterID) references Encounters(EncounterId),
    Constraint FK_Appointemnt_OPD_Visit Foreign Key (AppointmentID) References Appointments(AppointmentId)
...
CREATE TABLE Clinical_Management.Encounters (
    ...
    CreatedAt DATETIME2 DEFAULT GETDATE(),
    CreatedBy INT,
    CONSTRAINT FK_Encounters_Patient FOREIGN KEY (PatientId) REFERENCES Patient(PatientId),
    CONSTRAINT FK_Encounters_Provider FOREIGN KEY (PhysicianID) REFERENCES Staff(StaffId),
    CONSTRAINT FK_Encounters_Appointment FOREIGN KEY (AppointmentId) REFERENCES Appointments(AppointmentId),
    CONSTRAINT FK_Encounters_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Users(UserId),
...
CREATE TABLE Clinical_Management.VitalSigns (
    ...
    CONSTRAINT FK_VitalSigns_Encounter FOREIGN KEY (EncounterId) REFERENCES Encounters(EncounterId),
    CONSTRAINT FK_VitalSigns_RecordedBy FOREIGN KEY (RecordedBy) REFERENCES Staff(StaffId),
    Constraint Ck_Temp_Rang check (Temperature Between 32 and Temperature Or Temperature IS NULL),
...
CREATE TABLE Clinical_Management.Diagnoses (
    ...
    EncounterId INT NOT NULL,
    PatientId INT NOT NULL, 
    DiagnosisCode NVARCHAR(20) NOT NULL, -- Combined ICD10/ICD11
    DiagnosisDescription NVARCHAR(500) NOT NULL,
    DiagnosisType NVARCHAR(20) DEFAULT 'Primary' 
        CHECK (DiagnosisType IN ('Primary', 'Secondary')),
    Status NVARCHAR(20) DEFAULT 'Active' 
        CHECK (Status IN ('Active', 'Resolved', 'Chronic')),
    DiagnosisDate DATE DEFAULT GETDATE(),
    DiagnosedBy INT NOT NULL,
    Notes NVARCHAR(1000),
    CONSTRAINT FK_Diagnoses_Encounter FOREIGN KEY (EncounterId) REFERENCES Encounters(EncounterId),
    CONSTRAINT FK_Diagnoses_Patient FOREIGN KEY (PatientId) REFERENCES Patient(PatientId),
    CONSTRAINT FK_Diagnoses_Staff FOREIGN KEY (DiagnosedBy) REFERENCES Staff(StaffId)
);
...
CREATE TABLE Medication_Management.Medications (
    ...
    Form NVARCHAR(50), -- Tablet, Capsule, Injection
    Route NVARCHAR(50) DEFAULT 'Oral', 
    DrugClass NVARCHAR(100), -- Antibiotic, Analgesic, etc.
    IsActive BIT DEFAULT 1
);
...
CREATE TABLE Clinical_Management.Prescriptions (
    ...
    Quantity INT NOT NULL, -- Total tablets/bottles
    Instructions NVARCHAR(200), -- "Take after meals"
    ...
    CONSTRAINT FK_Prescriptions_PrescribedBy FOREIGN KEY (PrescribedBy) REFERENCES Staff(StaffId)
);
...
CREATE TABLE Order_Management.Orders (
    ...
    CONSTRAINT FK_Orders_Patient FOREIGN KEY (EncounterID) REFERENCES Encounters(EncounterID),
    CONSTRAINT FK_Orders_Doctor FOREIGN KEY (OrderingPhysicianID) REFERENCES Staff(StaffID)
);
...
(
    ...
    CONSTRAINT FK_Admissions_Encounter FOREIGN KEY (EncounterId) REFERENCES Encounters(EncounterId),
    CONSTRAINT FK_Admissions_Bed FOREIGN KEY (BedID) REFERENCES Beds(BedID),
    CONSTRAINT FK_Admissions_AdmittingPhysician FOREIGN KEY (AdmittingPhysicianID) REFERENCES Staff(StaffId),
    CONSTRAINT FK_Admissions_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Users(UserId)
...
CREATE TABLE Inpatient_Management.Beds (
    ...
    CONSTRAINT FK_BedTransfers_OrderedBy FOREIGN KEY (OrderedBy) REFERENCES Staff(StaffID)
);
...
CREATE TABLE Inpatient_Management.BedTransfers (
    ...
    CONSTRAINT FK_Transfers_Admission FOREIGN KEY (AdmissionId) REFERENCES Admissions(AdmissionId),
    CONSTRAINT FK_Transfers_FromBed FOREIGN KEY (FromBedId) REFERENCES Beds(BedId),
    CONSTRAINT FK_Transfers_ToBed FOREIGN KEY (ToBedId) REFERENCES Beds(BedId)
);

CREATE TABLE NursingTasks (
    TaskID INT IDENTITY(1,1) PRIMARY KEY,
    EncounterID INT NOT NULL,
    OrderedBy INT NULL, -- FK → Physicians / Orders
    TaskType NVARCHAR(50) NULL,
    ScheduledTime DATETIME NULL,  
    PerformedTime DATETIME NULL,
    PerformedBy INT NULL, -- Nurses
    Status NVARCHAR(20) CHECK (Status IN ('Planned','Done','Skipped')),
    CONSTRAINT FK_NursingTasks_Encounter FOREIGN KEY (EncounterID) REFERENCES Encounters(EncounterID),
    CONSTRAINT FK_NursingTasks_OrderedBy FOREIGN KEY (OrderedBy) REFERENCES Staff(StaffID),
    CONSTRAINT FK_NursingTasks_PerformedBy FOREIGN KEY (PerformedBy) REFERENCES Staff(StaffID)
);
...
CREATE TABLE Lab_Management.LabOrders (
    ...
    CONSTRAINT FK_LabOrders_OrderID FOREIGN KEY (LabOrderID) REFERENCES Orders(OrderID),
    CONSTRAINT FK_LabOrders_CollectedBy FOREIGN KEY (CollectedBy) REFERENCES Staff(StaffId),
    CONSTRAINT FK_LabOrders_PatientID FOREIGN KEY (PatientID) REFERENCES Patients(PatientID)
);
...
CREATE TABLE Lab_Management.LabTests (
    ...
    CONSTRAINT FK_LabTests_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Staff(StaffID)
);
...
CREATE TABLE Lab_Management.LabOrderTests (
    ...
    CONSTRAINT FK_LabOrderTests_LabOrder FOREIGN KEY (LabOrderID) REFERENCES LabOrders(LabOrderID),
    CONSTRAINT FK_LabOrderTests_Test FOREIGN KEY (TestID) REFERENCES LabTests(TestID)
);
...
CREATE TABLE Lab_Management.Specimen (
    ...
    CreatedDate DATETIME NOT NULL DEFAULT GETDATE(),
    CreatedBy INT NOT NULL,
    CONSTRAINT FK_Specimen_LabOrder FOREIGN KEY (LabOrderID) REFERENCES LabOrders(LabOrderID),
    CONSTRAINT FK_Specimen_CollectedBy FOREIGN KEY (CollectedBy) REFERENCES Staff(StaffID),
    CONSTRAINT FK_Specimen_ReceivedBy FOREIGN KEY (ReceivedBy) REFERENCES Staff(StaffID),
    CONSTRAINT FK_Specimen_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Staff(StaffID)
);
...
CREATE TABLE Lab_Management.LabResults (
    ...
    CONSTRAINT FK_LabResults_Specimen FOREIGN KEY (SpecimenID) REFERENCES Specimen(SpecimenID),
    CONSTRAINT FK_LabResults_Test FOREIGN KEY (TestID) REFERENCES LabTests(TestID),
    CONSTRAINT FK_LabResults_PerformedBy FOREIGN KEY (PerformedBy) REFERENCES Staff(StaffID),
    CONSTRAINT FK_LabResults_VerifiedBy FOREIGN KEY (VerifiedBy) REFERENCES Staff(StaffID)
);
...
CREATE TABLE Radiology_Management.RadiologyOrders (
    ...
    CONSTRAINT FK_RadiologyOrders_Orders FOREIGN KEY (RadiologyOrderID) REFERENCES Orders(OrderID)
);
...
CREATE TABLE Radiology_Management.ImagingStudy (
    ...
    CONSTRAINT FK_ImagingStudy_RadiologyOrder FOREIGN KEY (RadiologyOrderID) REFERENCES RadiologyOrders(RadiologyOrderID),
    CONSTRAINT FK_ImagingStudy_PerformedBy FOREIGN KEY (PerformedBy) REFERENCES Staff(StaffID)
);
...
CREATE TABLE Radiology_Management.ImagingSeries (
    ...
    CONSTRAINT FK_ImagingSeries_Study FOREIGN KEY (StudyID) REFERENCES ImagingStudy(StudyID)
);
...
CREATE TABLE Radiology_Management.PACSImage (
    ...
    ImageNumber INT NULL, -- Added for ordering
    -- Foreign Keys
    CONSTRAINT FK_PACSImage_Series FOREIGN KEY (SeriesID) REFERENCES ImagingSeries(SeriesID)
);
...
CREATE TABLE Radiology_Management.RadiologyReport (
    ...
    CONSTRAINT FK_RadiologyReport_Study FOREIGN KEY (StudyID) REFERENCES ImagingStudy(StudyID),
    CONSTRAINT FK_RadiologyReport_ReportedBy FOREIGN KEY (ReportedBy) REFERENCES Staff(StaffID)
);
...
CREATE TABLE surgery_Management.Procedures (
    ...
    CreatedBy INT,
    CONSTRAINT FK_Procedures_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Users(UserID)
...
CREATE TABLE surgery_Management.SurgerySchedule (
    ...
    Constraint FK_OrderID_SurgerySchedule foreign key (OrderID) References Orders(OrderID),
    Constraint FK_AddmissionID_SurgerySchedule foreign key (AdmissionID) References Admissions(AdmissionID),
    Constraint FK_OPDVisitID_SurgerySchedule foreign key (OPDVisitID) References OPD_Visit(OPDVisitID),
    Constraint Fk_ORRooms foreign Key (ORRoomID) References OR_Rooms(ORRoomID) ,
    Constraint FK_SurgerySchedule_CreatedBy Foreign key (CreatedBy) References Staff(StaffID),
...
CREATE TABLE surgery_Management.SurgeryTeam (
    ...
    Constraint FK_StaffID_SurgeryTeam Foreign key (StaffID) References Staff(StaffID), 
    Constraint FK_SurgeryID_SurgeryTeam Foreign Key (SurgeryID) References SurgerySchedule(SurgeryID)
);
...
CREATE TABLE surgery_Management.SurgeryNotes (
    ...
    Constraint FK_SurgeryID_SurgeryNotes Foreign key (SurgeryID) References SurgerySchedule(SurgeryID),
);
...
CREATE TABLE finance_Management.Services (
    ...
    CONSTRAINT FK_Services_Department FOREIGN KEY (DepartmentID) REFERENCES Departments(DepartmentID)
);
...
CREATE TABLE finance_Management.InsurancePlans (
    ...
    CONSTRAINT FK_InsurancePlans_Payer FOREIGN KEY (PayerID) REFERENCES Payers(PayerID)
);
...
CREATE TABLE Patient_Management.PatientInsurance (
    ...
    CONSTRAINT FK_PatientInsurance_Patient FOREIGN KEY (PatientID) REFERENCES Patient(PatientID)
);
...
CREATE TABLE finance_Management.Invoices (
    ...
    CONSTRAINT FK_Invoices_Patient FOREIGN KEY (PatientID) REFERENCES Patient(PatientID),
    CONSTRAINT FK_Invoices_Encounter FOREIGN KEY (EncounterID) REFERENCES Encounters(EncounterID),
    CONSTRAINT FK_Invoices_Payer FOREIGN KEY (PayerID) REFERENCES Payers(PayerID),
    CONSTRAINT FK_Invoices_CreatedBy FOREIGN KEY (CreatedBy) REFERENCES Staff(StaffID)
);
CREATE TABLE finance_Management.InvoiceLines (
    ...
    CONSTRAINT FK_InvoiceLines_Service FOREIGN KEY (ServiceID) REFERENCES Services(ServiceID),
    CONSTRAINT FK_InvoiceLines_Order FOREIGN KEY (OrderID) REFERENCES Orders(OrderID)
);
...
CREATE TABLE finance_Management.Payments (
    ...
    CONSTRAINT FK_Payments_Payer FOREIGN KEY (PayerID) REFERENCES Payers(PayerID),
    CONSTRAINT FK_Payments_ReceivedBy FOREIGN KEY (ReceivedBy) REFERENCES Staff(StaffID)
);
